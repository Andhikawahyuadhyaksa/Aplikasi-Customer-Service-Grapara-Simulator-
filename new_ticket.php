            ...
            <form action="" id="manage_ticket">
                ...
                <?php if($_SESSION['login_type'] == 3): ?>
                    <div class="form-group">
                        ...
                        <select name="customer_id" id="customer_id" class="custom-select custom-select-sm select2">
                            <option value=""></option>
                        <?php
                            $customers = $conn->query("SELECT *,concat(lastname,', ',firstname,' ',middlename) as name FROM customers ORDER BY concat(lastname,', ',firstname,' ',middlename) ASC");
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea name="problem" id="" cols="30" rows="10" class="form-control summernote"><?php echo isset($description) ? $description : '' ?></textarea>
                    </div>
                </div>
                <hr>
