...
<head>
    ...
    <title>Login | Customer Service Grapara</title>
...
<body class="bg-dark">
    <main id="main">
        <div class="align-self-center w-100">
            <h4 class="text-white text-center"><b>Customer Service Grapara</b></h4>
                ...
                <div class="card col-md-4">
                    <div class="card-body">
                        <form id="login-form">
                            ...
                            <div class="form-group">
                                <label for="type" class="control-label text-dark">Type</label>
