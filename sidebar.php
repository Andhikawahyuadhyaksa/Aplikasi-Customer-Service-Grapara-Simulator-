        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <?php if ($_SESSION['login_type'] == 1) : ?>
                    ...
                    <li class="nav-item">
                        <a href="./index.php?page=tables_list" class="nav-link nav-tables_list">
                ...
                <?php endif; ?>
                <li <?php echo ($_SESSION['login_type'] == 1 || $_SESSION['login_type'] == 2) ? 'hidden' : ''; ?> class="nav-item">
                    ...
                    <!-- New Stats Menu Item -->
                <li <?php echo $_SESSION['login_type'] == 2 ? '' : 'hidden'; ?> class="nav-item">
                    <a href="#" class="nav-link nav-stats">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="./index.php?page=daily_stats" class="nav-link nav-daily_stats tree-item">
                                <i class="fas fa-angle-right nav-icon"></i>
                                <p>Daily Stats</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="./index.php?page=cs_stats" class="nav-link nav-cs_stats tree-item">
                                <i class="fas fa-angle-right nav-icon"></i>
                                <p>CS Stats</p>
                            </a>
                        </li>
                ...
                <li <?php echo $_SESSION['login_type'] == 2 ? '' : 'hidden'; ?> class="nav-item">
                    <a href="./index.php?page=weekly_report" class="nav-link nav-weekly_report">
